...
var AUTH = 'lIQzyHdCQBBTbauSWYrnneHp'; //set the auth of your bot here.
var USERID = '605e612747b5e3001a98589a'; //set the userid of your bot here.
var ROOMID = '604097443f4bfc001be4ce97'; //set the roomid of the room you want the bot to go to here.
var playLimit = 4; //set the playlimit here (default 4 songs)
var afkLimit = 20; //set the afk limit in minutes here
var howOftenToRepeatMessage = 30; //how often (in minutes) to repeat the room message (this corresponds to the MESSAGE variable below, only works when MESSAGE = true;)
...
var roomJoinMessage = 'Hi DJs. Be nice. Play stuff. Have fun. And don\'t forget to Yfel ongehýðnesswefn besl¯æpan.'; //the message users will see when they join the room, leave it empty for the default message (only works when greet is turned on)
...
global.bannedUsers = ['636473737373', 'bob', '535253533353', 'joe','604998a447c69b001b5272b2','6067606c47b5e3001a63f068','6067778647b5e3001a63f297','606779bc47b5e3001a63f2e4', '606e1aea47c69b001b39d8a4', '606e1bd847c69b001b39d8e1', '606f68c547b5e3001b33c70b', '606f758847c69b001b39f0f1', '606e616247b5e3001b33b821', '606f69ee47c69b001b39efd4', 'The Saugine Penguin', 'DJ Epstien']; //banned users list, put userids in string form here for permanent banning(put their name after their userid to tell who is banned).
...
var getonstage = false; //autodjing(on by default)
...
var bot = new Bot(AUTH, USERID); //initializes the bot
